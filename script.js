const people = [
    ...
    {name: "ادم فينوم", desc: "عيل مش راجل وبيفضل يكلم بنات كتير وكل يوم يحب ف واحده غير انه منافق بيتكلم ف وشك غير ف ضهرك وبيتكلم علي صحابو وبيفضل يعرض لل بنات وبيخش يكلم اللي صحابو مرتبطين بيهم ويتمحك فيهم عشان يبصولو ويبين انه بيحبك جدا ويبقا كويس قدامك وتلاقيه بيخونك وبيتكلم عليك فضهرك"},
];
